...
var ModalBody = ({ children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime44.jsx)("div", { className: twMerge(theme2.base, popup && [theme2.popup], className), ...props, children });
};
...
var ModalHeader = ({ as: Component = "h3", children, className, theme: customTheme = {}, id, ...props }) => {
  ...
  return (0, import_jsx_runtime46.jsxs)("div", { className: twMerge(theme2.base, popup && theme2.popup, className), ...props, children: [(0, import_jsx_runtime46.jsx)(Component, { id: headerId, className: theme2.title, children }), (0, import_jsx_runtime46.jsx)("button", { "aria-label": "Close", className: theme2.close.base, type: "button", onClick: onClose, children: (0, import_jsx_runtime46.jsx)(HiOutlineX, { "aria-hidden": true, className: theme2.close.icon }) })] });
};
...
var ModalComponent = (0, import_react28.forwardRef)(({ children, className, dismissible = false, onClose, popup, position = "center", root, show, size: size2 = "2xl", theme: customTheme = {}, initialFocus, ...props }, theirRef) => {
  ...
  return (0, import_jsx_runtime47.jsx)(ModalContext.Provider, { value: { popup, onClose, setHeaderId }, children: (0, import_jsx_runtime47.jsx)(FloatingPortal, { root, children: (0, import_jsx_runtime47.jsx)(FloatingOverlay, { lockScroll: true, "data-testid": "modal-overlay", className: twMerge(theme2.root.base, theme2.root.positions[position], show ? theme2.root.show.on : theme2.root.show.off, className), ...props, children: (0, import_jsx_runtime47.jsx)(FloatingFocusManager, { context, initialFocus, children: (0, import_jsx_runtime47.jsx)("div", { ref, ...getFloatingProps(props), "aria-labelledby": headerId, className: twMerge(theme2.content.base, theme2.root.sizes[size2]), children: (0, import_jsx_runtime47.jsx)("div", { className: theme2.content.inner, children }) }) }) }) }) });
});
...
var NavbarBrand = ({ as: Component = "a", children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime48.jsx)(Component, { className: twMerge(theme2.base, className), ...props, children });
};
...
var NavbarCollapse = ({ children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime49.jsx)("div", { "data-testid": "flowbite-navbar-collapse", className: twMerge(theme2.base, theme2.hidden[!isOpen ? "on" : "off"], className), ...props, children: (0, import_jsx_runtime49.jsx)("ul", { className: theme2.list, children }) });
};
...
var NavbarLink = ({ active, as: Component = "a", disabled, children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime50.jsx)("li", { children: (0, import_jsx_runtime50.jsx)(Component, { className: twMerge(theme2.base, active && theme2.active.on, !active && !disabled && theme2.active.off, theme2.disabled[disabled ? "on" : "off"], className), ...props, children }) });
};
...
var NavbarToggle = ({ barIcon: BarIcon = FaBars, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime51.jsxs)("button", { "data-testid": "flowbite-navbar-toggle", onClick: handleClick, className: twMerge(theme2.base, className), ...props, children: [(0, import_jsx_runtime51.jsx)("span", { className: "sr-only", children: "Open main menu" }), (0, import_jsx_runtime51.jsx)(BarIcon, { "aria-hidden": true, className: theme2.icon })] });
};
...
var NavbarComponent = ({ border, children, className, fluid = false, menuOpen, rounded, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime52.jsx)(NavbarContext.Provider, { value: { isOpen, setIsOpen }, children: (0, import_jsx_runtime52.jsx)("nav", { className: twMerge(theme2.base, theme2.bordered[border ? "on" : "off"], theme2.rounded[rounded ? "on" : "off"], className), ...props, children: (0, import_jsx_runtime52.jsx)("div", { className: twMerge(theme2.inner.base, theme2.inner.fluid[fluid ? "on" : "off"]), children }) }) });
};
...
var PaginationButton = ({ active, children, className, onClick, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime53.jsx)("button", { type: "button", className: twMerge(active && theme2.pages.selector.active, className), onClick, ...props, children });
};
PaginationButton.displayName = "Pagination.Button";
var PaginationNavigation = ({ children, className, onClick, theme: customTheme = {}, disabled = false, ...props }) => {
  const theme2 = mergeDeep(useTheme().theme.pagination, customTheme);
  return (0, import_jsx_runtime53.jsx)("button", { type: "button", className: twMerge(disabled && theme2.pages.selector.disabled, className), disabled, onClick, ...props, children });
};
...
// node_modules/flowbite-react/lib/esm/components/Pagination/Pagination.js
var PaginationComponent = ({ className, currentPage, layout = "pagination", nextLabel = "Next", onPageChange, previousLabel = "Previous", renderPaginationButton = (props2) => (0, import_jsx_runtime54.jsx)(PaginationButton, { ...props2 }), showIcons: showIcon = false, theme: customTheme = {}, totalPages, ...props }) => {
  const theme2 = mergeDeep(useTheme().theme.pagination, customTheme);
  ...
  return (0, import_jsx_runtime54.jsxs)("nav", { className: twMerge(theme2.base, className), ...props, children: [layout === "table" && (0, import_jsx_runtime54.jsxs)("div", { className: theme2.layout.table.base, children: ["Showing ", (0, import_jsx_runtime54.jsx)("span", { className: theme2.layout.table.span, children: firstPage }), " to ", (0, import_jsx_runtime54.jsx)("span", { className: theme2.layout.table.span, children: lastPage }), " of ", (0, import_jsx_runtime54.jsx)("span", { className: theme2.layout.table.span, children: totalPages }), " Entries"] }), (0, import_jsx_runtime54.jsxs)("ul", { className: theme2.pages.base, children: [(0, import_jsx_runtime54.jsx)("li", { children: (0, import_jsx_runtime54.jsxs)(PaginationNavigation, { className: twMerge(theme2.pages.previous.base, showIcon && theme2.pages.showIcon), onClick: goToPreviousPage, disabled: currentPage === 1, children: [showIcon && (0, import_jsx_runtime54.jsx)(HiChevronLeft, { "aria-hidden": true, className: theme2.pages.previous.icon }), previousLabel] }) }), layout === "pagination" && range(firstPage, lastPage).map((page) => (0, import_jsx_runtime54.jsx)("li", { "aria-current": page === currentPage ? "page" : void 0, children: renderPaginationButton({
    className: twMerge(theme2.pages.selector.base, currentPage === page && theme2.pages.selector.active),
    active: page === currentPage,
    onClick: () => onPageChange(page),
    children: page
  }) }, page)), (0, import_jsx_runtime54.jsx)("li", { children: (0, import_jsx_runtime54.jsxs)(PaginationNavigation, { className: twMerge(theme2.pages.next.base, showIcon && theme2.pages.showIcon), onClick: goToNextPage, disabled: currentPage === totalPages, children: [nextLabel, showIcon && (0, import_jsx_runtime54.jsx)(HiChevronRight, { "aria-hidden": true, className: theme2.pages.next.icon })] }) })] })] });
};
...
var Progress = ({ className, color = "blue", labelProgress = false, labelText = false, progress, progressLabelPosition = "inside", size: size2 = "md", textLabel = "progressbar", textLabelPosition = "inside", theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime55.jsx)(import_jsx_runtime55.Fragment, { children: (0, import_jsx_runtime55.jsxs)("div", { id, "aria-label": textLabel, "aria-valuenow": progress, role: "progressbar", ...props, children: [(textLabel && labelText && textLabelPosition === "outside" || progress > 0 && labelProgress && progressLabelPosition === "outside") && (0, import_jsx_runtime55.jsxs)("div", { className: theme2.label, "data-testid": "flowbite-progress-outer-label-container", children: [textLabel && labelText && textLabelPosition === "outside" && (0, import_jsx_runtime55.jsx)("span", { "data-testid": "flowbite-progress-outer-text-label", children: textLabel }), labelProgress && progressLabelPosition === "outside" && (0, import_jsx_runtime55.jsxs)("span", { "data-testid": "flowbite-progress-outer-progress-label", children: [progress, "%"] })] }), (0, import_jsx_runtime55.jsx)("div", { className: twMerge(theme2.base, theme2.size[size2], className), children: (0, import_jsx_runtime55.jsxs)("div", { style: { width: `${progress}%` }, className: twMerge(theme2.bar, theme2.color[color], theme2.size[size2]), children: [textLabel && labelText && textLabelPosition === "inside" && (0, import_jsx_runtime55.jsx)("span", { "data-testid": "flowbite-progress-inner-text-label", children: textLabel }), progress > 0 && labelProgress && progressLabelPosition === "inside" && (0, import_jsx_runtime55.jsxs)("span", { "data-testid": "flowbite-progress-inner-progress-label", children: [progress, "%"] })] }) })] }) });
};
...
var Radio = (0, import_react32.forwardRef)(({ className, theme: customTheme = {}, ...props }, ref) => {
  ...
  return (0, import_jsx_runtime56.jsx)("input", { ref, type: "radio", className: twMerge(theme2.root.base, className), ...props });
});
...
var RatingAdvanced = ({ children, className, percentFilled = 0, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime58.jsxs)("div", { className: twMerge(theme2.base, className), ...props, children: [(0, import_jsx_runtime58.jsx)("span", { className: theme2.label, children }), (0, import_jsx_runtime58.jsx)("div", { className: theme2.progress.base, children: (0, import_jsx_runtime58.jsx)("div", { className: theme2.progress.fill, "data-testid": "flowbite-rating-fill", style: { width: `${percentFilled}%` } }) }), (0, import_jsx_runtime58.jsx)("span", { className: theme2.progress.label, children: `${percentFilled}%` })] });
};
...
var RatingStar = ({ className, filled = true, starIcon: Icon = HiStar, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime59.jsx)(Icon, { "data-testid": "flowbite-rating-star", className: twMerge(theme2.sizes[size2], theme2[filled ? "filled" : "empty"], className), ...props });
};
...
var RatingComponent = ({ children, className, size: size2 = "sm", theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime60.jsx)(RatingContext.Provider, { value: { size: size2 }, children: (0, import_jsx_runtime60.jsx)("div", { className: twMerge(theme2.root.base, className), ...props, children }) });
};
...
var Select = (0, import_react35.forwardRef)(({ addon, children, className, color = "gray", helperText, icon: Icon, shadow, sizing = "md", theme: customTheme = {}, ...props }, ref) => {
  ...
  return (0, import_jsx_runtime61.jsxs)("div", { className: twMerge(theme2.base, className), children: [addon && (0, import_jsx_runtime61.jsx)("span", { className: theme2.addon, children: addon }), (0, import_jsx_runtime61.jsxs)("div", { className: theme2.field.base, children: [Icon && (0, import_jsx_runtime61.jsx)("div", { className: theme2.field.icon.base, children: (0, import_jsx_runtime61.jsx)(Icon, { className: theme2.field.icon.svg }) }), (0, import_jsx_runtime61.jsx)("select", { className: twMerge(theme2.field.select.base, theme2.field.select.colors[color], theme2.field.select.sizes[sizing], theme2.field.select.withIcon[Icon ? "on" : "off"], theme2.field.select.withAddon[addon ? "on" : "off"], theme2.field.select.withShadow[shadow ? "on" : "off"]), ...props, ref, children }), helperText && (0, import_jsx_runtime61.jsx)(HelperText, { color, children: helperText })] })] });
});
...
var SidebarCTA = ({ children, color = "info", className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime62.jsx)("div", { "data-testid": "sidebar-cta", hidden: isCollapsed, className: twMerge(theme2.base, theme2.color[color], className), ...props, children });
};
...
var SidebarCollapse = ({ children, className, icon: Icon, label, chevronIcon: ChevronIcon = HiChevronDown, renderChevronIcon, open = false, theme: customTheme = {}, ...props }) => {
  ...
  const Wrapper = ({ children: children2 }) => (0, import_jsx_runtime63.jsx)("li", { children: isCollapsed && !isOpen ? (0, import_jsx_runtime63.jsx)(Tooltip, { content: label, placement: "right", children: children2 }) : children2 });
  return (0, import_jsx_runtime63.jsxs)(Wrapper, { children: [(0, import_jsx_runtime63.jsxs)("button", { id: `flowbite-sidebar-collapse-${id}`, onClick: () => setOpen(!isOpen), title: label, type: "button", className: twMerge(theme2.button, className), ...props, children: [Icon && (0, import_jsx_runtime63.jsx)(Icon, { "aria-hidden": true, "data-testid": "flowbite-sidebar-collapse-icon", className: twMerge(theme2.icon.base, theme2.icon.open[isOpen ? "on" : "off"]) }), isCollapsed ? (0, import_jsx_runtime63.jsx)("span", { className: "sr-only", children: label }) : (0, import_jsx_runtime63.jsxs)(import_jsx_runtime63.Fragment, { children: [(0, import_jsx_runtime63.jsx)("span", { "data-testid": "flowbite-sidebar-collapse-label", className: theme2.label.base, children: label }), renderChevronIcon ? renderChevronIcon(theme2, isOpen) : (0, import_jsx_runtime63.jsx)(ChevronIcon, { "aria-hidden": true, className: twMerge(theme2.label.icon.base, theme2.label.icon.open[isOpen ? "on" : "off"]) })] })] }), (0, import_jsx_runtime63.jsx)("ul", { "aria-labelledby": `flowbite-sidebar-collapse-${id}`, hidden: !isOpen, className: theme2.list, children: (0, import_jsx_runtime63.jsx)(SidebarItemContext.Provider, { value: { isInsideCollapse: true }, children }) })] });
};
...
var ListItem = ({ id, isCollapsed, tooltipChildren, children: wrapperChildren, ...props }) => (0, import_jsx_runtime64.jsx)("li", { ...props, children: isCollapsed ? (0, import_jsx_runtime64.jsx)(Tooltip, { content: (0, import_jsx_runtime64.jsx)(TooltipContent, { id, children: tooltipChildren }), placement: "right", children: wrapperChildren }) : wrapperChildren });
var TooltipContent = ({ id, children }) => (0, import_jsx_runtime64.jsx)(Children4, { id, children });
var Children4 = ({ id, children }) => {
  const theme2 = useTheme().theme.sidebar.item;
  return (0, import_jsx_runtime64.jsx)("span", { "data-testid": "flowbite-sidebar-item-content", id: `flowbite-sidebar-item-${id}`, className: twMerge(theme2.content.base), children });
};
...
var SidebarItemGroup = ({ children, className, ...props }) => {
  ...
  return (0, import_jsx_runtime65.jsx)("ul", { "data-testid": "flowbite-sidebar-item-group", className: twMerge(theme2, className), ...props, children: (0, import_jsx_runtime65.jsx)(SidebarItemContext.Provider, { value: { isInsideCollapse: false }, children }) });
};
...
var SidebarItems = ({ children, className, ...props }) => {
  ...
  return (0, import_jsx_runtime66.jsx)("div", { className: twMerge(theme2, className), "data-testid": "flowbite-sidebar-items", ...props, children });
};
...
var SidebarLogo = ({ children, className, href, img, imgAlt = "", theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime67.jsxs)("a", { "aria-labelledby": `flowbite-sidebar-logo-${id}`, href, className: twMerge(theme2.base, className), ...props, children: [(0, import_jsx_runtime67.jsx)("img", { alt: imgAlt, src: img, className: theme2.img }), (0, import_jsx_runtime67.jsx)("span", { className: theme2.collapsed[isCollapsed ? "on" : "off"], id: `flowbite-sidebar-logo-${id}`, children })] });
};
...
var SidebarComponent = ({ children, as: Component = "nav", collapseBehavior = "collapse", collapsed: isCollapsed = false, theme: customTheme = {}, className, ...props }) => {
  ...
  return (0, import_jsx_runtime68.jsx)(SidebarContext.Provider, { value: { isCollapsed }, children: (0, import_jsx_runtime68.jsx)(Component, { "aria-label": "Sidebar", hidden: isCollapsed && collapseBehavior === "hide", className: twMerge(theme2.root.base, theme2.root.collapsed[isCollapsed ? "on" : "off"], className), ...props, children: (0, import_jsx_runtime68.jsx)("div", { className: theme2.root.inner, children }) }) });
};
...
var Spinner = ({ className, color = "info", light, size: size2 = "md", theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime69.jsx)("span", { role: "status", ...props, children: (0, import_jsx_runtime69.jsxs)("svg", { fill: "none", viewBox: "0 0 100 101", className: twMerge(theme2.base, theme2.color[color], theme2.light[light ? "on" : "off"].base, theme2.light[light ? "on" : "off"].color[color], theme2.size[size2], className), children: [(0, import_jsx_runtime69.jsx)("path", { d: "M100 50.5908C100 78.2051 77.6142 100.591 50 100.591C22.3858 100.591 0 78.2051 0 50.5908C0 22.9766 22.3858 0.59082 50 0.59082C77.6142 0.59082 100 22.9766 100 50.5908ZM9.08144 50.5908C9.08144 73.1895 27.4013 91.5094 50 91.5094C72.5987 91.5094 90.9186 73.1895 90.9186 50.5908C90.9186 27.9921 72.5987 9.67226 50 9.67226C27.4013 9.67226 9.08144 27.9921 9.08144 50.5908Z", fill: "currentColor" }), (0, import_jsx_runtime69.jsx)("path", { d: "M93.9676 39.0409C96.393 38.4038 97.8624 35.9116 97.0079 33.5539C95.2932 28.8227 92.871 24.3692 89.8167 20.348C85.8452 15.1192 80.8826 10.7238 75.2124 7.41289C69.5422 4.10194 63.2754 1.94025 56.7698 1.05124C51.7666 0.367541 46.6976 0.446843 41.7345 1.27873C39.2613 1.69328 37.813 4.19778 38.4501 6.62326C39.0873 9.04874 41.5694 10.4717 44.0505 10.1071C47.8511 9.54855 51.7191 9.52689 55.5402 10.0491C60.8642 10.7766 65.9928 12.5457 70.6331 15.2552C75.2735 17.9648 79.3347 21.5619 82.5849 25.841C84.9175 28.9121 86.7997 32.2913 88.1811 35.8758C89.083 38.2158 91.5421 39.6781 93.9676 39.0409Z", fill: "currentFill" })] }) });
};
...
var TabItem = ({ children, className }) => (0, import_jsx_runtime70.jsx)("div", { className, children });
...
var TabsComponent = (0, import_react41.forwardRef)(({ children, className, onActiveTabChange, style = "default", theme: customTheme = {}, ...props }, ref) => {
  ...
  return (0, import_jsx_runtime71.jsxs)("div", { className: twMerge(theme2.base, className), children: [(0, import_jsx_runtime71.jsx)("div", { "aria-label": "Tabs", role: "tablist", className: twMerge(theme2.tablist.base, theme2.tablist.styles[style], className), ...props, children: tabs.map((tab, index3) => (0, import_jsx_runtime71.jsxs)("button", { type: "button", "aria-controls": `${id}-tabpanel-${index3}`, "aria-selected": index3 === activeTab, className: twMerge(theme2.tablist.tabitem.base, tabItemStyle.base, index3 === activeTab && tabItemStyle.active.on, index3 !== activeTab && !tab.disabled && tabItemStyle.active.off), disabled: tab.disabled, id: `${id}-tab-${index3}`, onClick: () => handleClick({ target: index3 }), onKeyDown: (event) => handleKeyboard({ event, target: index3 }), ref: (element) => tabRefs.current[index3] = element, role: "tab", tabIndex: index3 === focusedTab ? 0 : -1, children: [tab.icon && (0, import_jsx_runtime71.jsx)(tab.icon, { className: theme2.tablist.tabitem.icon }), tab.title] }, index3)) }), (0, import_jsx_runtime71.jsx)("div", { children: tabs.map((tab, index3) => (0, import_jsx_runtime71.jsx)("div", { "aria-labelledby": `${id}-tab-${index3}`, className: theme2.tabpanel, hidden: index3 !== activeTab, id: `${id}-tabpanel-${index3}`, role: "tabpanel", tabIndex: 0, children: tab.children }, index3)) })] });
});
...
var TableBody = ({ children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime72.jsx)("tbody", { className: twMerge(theme2.base, className), ...props, children });
};
...
var TableCell = ({ children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime73.jsx)("td", { className: twMerge(theme2.base, className), ...props, children });
};
...
var TableHead = ({ children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime74.jsx)("thead", { className: twMerge(theme2.head.base, className), ...props, children: (0, import_jsx_runtime74.jsx)("tr", { children }) });
};
...
var TableHeadCell = ({ children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime75.jsx)("th", { className: twMerge(theme2.base, className), ...props, children });
};
...
var TableRow = ({ children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime76.jsx)("tr", { "data-testid": "table-row-element", className: twMerge(theme2.base, striped && theme2.striped, hoverable && theme2.hovered, className), ...props, children });
};

// node_modules/flowbite-react/lib/esm/components/Table/Table.js
var TableComponent = ({ children, className, hoverable, striped, theme: customTheme = {}, ...props }) => {
  const theme2 = mergeDeep(useTheme().theme.table, customTheme);
  return (0, import_jsx_runtime77.jsx)("div", { "data-testid": "table-element", className: twMerge(theme2.root.wrapper), children: (0, import_jsx_runtime77.jsxs)(TableContext.Provider, { value: { striped, hoverable }, children: [(0, import_jsx_runtime77.jsx)("div", { className: twMerge(theme2.root.shadow, className) }), (0, import_jsx_runtime77.jsx)("table", { className: twMerge(theme2.root.base, className), ...props, children })] }) });
};
...
var TextInput = (0, import_react43.forwardRef)(({ addon, className, color = "gray", helperText, icon: Icon, rightIcon: RightIcon, shadow, sizing = "md", theme: customTheme = {}, ...props }, ref) => {
  ...
  return (0, import_jsx_runtime78.jsxs)(import_jsx_runtime78.Fragment, { children: [(0, import_jsx_runtime78.jsxs)("div", { className: twMerge(theme2.base, className), children: [addon && (0, import_jsx_runtime78.jsx)("span", { className: theme2.addon, children: addon }), (0, import_jsx_runtime78.jsxs)("div", { className: theme2.field.base, children: [Icon && (0, import_jsx_runtime78.jsx)("div", { className: theme2.field.icon.base, children: (0, import_jsx_runtime78.jsx)(Icon, { className: theme2.field.icon.svg }) }), RightIcon && (0, import_jsx_runtime78.jsx)("div", { "data-testid": "right-icon", className: theme2.field.rightIcon.base, children: (0, import_jsx_runtime78.jsx)(RightIcon, { className: theme2.field.rightIcon.svg }) }), (0, import_jsx_runtime78.jsx)("input", { className: twMerge(theme2.field.input.base, theme2.field.input.colors[color], theme2.field.input.sizes[sizing], theme2.field.input.withIcon[Icon ? "on" : "off"], theme2.field.input.withRightIcon[RightIcon ? "on" : "off"], theme2.field.input.withAddon[addon ? "on" : "off"], theme2.field.input.withShadow[shadow ? "on" : "off"]), ...props, ref })] })] }), helperText && (0, import_jsx_runtime78.jsx)(HelperText, { color, children: helperText })] });
});
...
var Textarea = (0, import_react44.forwardRef)(({ className, color = "gray", helperText, shadow, theme: customTheme = {}, ...props }, ref) => {
  ...
  return (0, import_jsx_runtime79.jsxs)(import_jsx_runtime79.Fragment, { children: [(0, import_jsx_runtime79.jsx)("textarea", { ref, className: twMerge(theme2.base, theme2.colors[color], theme2.withShadow[shadow ? "on" : "off"], className), ...props }), helperText && (0, import_jsx_runtime79.jsx)(HelperText, { color, children: helperText })] });
});
...
var TimelineBody = ({ children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime80.jsx)("div", { className: twMerge(theme2, className), ...props, children });
};
...
var TimelineContent = ({ children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime81.jsx)("div", { "data-testid": "timeline-content", className: twMerge(horizontal && theme2.root.base, className), ...props, children });
};
...
var TimelineItem = ({ children, className, theme: customTheme = {}, ...props }) => {
  ...
  const { horizontal } = useTimelineContext();
  return (0, import_jsx_runtime82.jsx)("li", { "data-testid": "timeline-item", className: twMerge(horizontal && theme2.root.horizontal, !horizontal && theme2.root.vertical, className), ...props, children });
};
...
var TimelinePoint = ({ children, className, icon: Icon, theme: customTheme = {}, ...props }) => {
  ...
  const { horizontal } = useTimelineContext();
  return (0, import_jsx_runtime83.jsxs)("div", { "data-testid": "timeline-point", className: twMerge(horizontal && theme2.horizontal, !horizontal && theme2.vertical, className), ...props, children: [children, Icon ? (0, import_jsx_runtime83.jsx)("span", { className: twMerge(theme2.marker.icon.wrapper), children: (0, import_jsx_runtime83.jsx)(Icon, { "aria-hidden": true, className: twMerge(theme2.marker.icon.base) }) }) : (0, import_jsx_runtime83.jsx)("div", { className: twMerge(horizontal && theme2.marker.base.horizontal, !horizontal && theme2.marker.base.vertical) }), horizontal && (0, import_jsx_runtime83.jsx)("div", { className: twMerge(theme2.line) })] });
};
...
var TimelineTime = ({ children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime84.jsx)("time", { className: twMerge(theme2, className), ...props, children });
};
...
var TimelineTitle = ({ as: Tag = "h3", children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime85.jsx)(Tag, { className: twMerge(theme2, className), ...props, children });
};
...
var TimelineComponent = ({ children, className, horizontal, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime86.jsx)(TimelineContext.Provider, { value: { horizontal }, children: (0, import_jsx_runtime86.jsx)("ol", { "data-testid": "timeline-component", className: twMerge(horizontal && theme2.root.direction.horizontal, !horizontal && theme2.root.direction.vertical, className), ...props, children }) });
};
...
var ToastToggle = ({ className, onClick, theme: customTheme = {}, xIcon: XIcon = HiX, onDismiss, ...props }) => {
  ...
  return (0, import_jsx_runtime87.jsx)("button", { "aria-label": "Close", onClick: handleClick, type: "button", className: twMerge(theme2.base, className), ...props, children: (0, import_jsx_runtime87.jsx)(XIcon, { "aria-hidden": true, className: theme2.icon }) });
};
...
var ToastComponent = ({ children, className, duration = 300, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime88.jsx)(ToastContext.Provider, { value: { duration, isClosed, isRemoved, setIsClosed, setIsRemoved }, children: (0, import_jsx_runtime88.jsx)("div", { "data-testid": "flowbite-toast", role: "alert", className: twMerge(theme2.root.base, durationClasses[duration], isClosed && theme2.root.closed, className), ...props, children }) });
};
...
var ToggleSwitch = ({ checked, className, color = "blue", disabled, label, name, onChange, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime89.jsxs)(import_jsx_runtime89.Fragment, { children: [name && checked && (0, import_jsx_runtime89.jsx)("input", { checked, hidden: true, name, readOnly: true, type: "checkbox", className: "sr-only" }), (0, import_jsx_runtime89.jsxs)("button", { "aria-checked": checked, "aria-labelledby": `${id}-flowbite-toggleswitch-label`, disabled, id: `${id}-flowbite-toggleswitch`, onClick: handleClick, onKeyPress: handleKeyPress, role: "switch", tabIndex: 0, type: "button", className: twMerge(theme2.root.base, theme2.root.active[disabled ? "off" : "on"], className), ...props, children: [(0, import_jsx_runtime89.jsx)("div", { "data-testid": "flowbite-toggleswitch-toggle", className: twMerge(theme2.toggle.base, theme2.toggle.checked[checked ? "on" : "off"], !disabled && checked && theme2.toggle.checked.color[color]) }), (0, import_jsx_runtime89.jsx)("span", { "data-testid": "flowbite-toggleswitch-label", id: `${id}-flowbite-toggleswitch-label`, className: theme2.root.label, children: label })] })] });
};
...
var Tooltip = ({ animation = "duration-300", arrow: arrow3 = true, children, className, content, placement = "top", style = "dark", theme: customTheme = {}, trigger = "hover", ...props }) => {
  ...
  return (0, import_jsx_runtime91.jsx)(Floating, { animation, arrow: arrow3, content, placement, style, theme: theme2, trigger, className, ...props, children });
};
