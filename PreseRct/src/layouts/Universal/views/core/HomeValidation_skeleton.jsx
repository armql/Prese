        ...
        <div className='bg-white backdrop-filter backdrop-blur-lg bg-opacity-20'>
            ...
            <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
                ...
                <div className="text-center">
                    <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl animate-pulse">
                        <div class="h-3.5 bg-gray-500 rounded-full max-w-[640px] mb-3.5 mx-auto"></div>
                    ...
                    <div className="mt-10 flex items-center justify-center gap-x-6">
                        <div
                            className="rounded-md animate-pulse w-40 h-8 bg-red-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm transition:1s focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                        >
                        </div>
                        <div className="text-sm font-semibold leading-6 text-gray-900">
                            <Link to='/aboutus' ><div class="h-4 bg-gray-700 rounded-full w-40 animate-pulse"></div></Link>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <section className="bg-white backdrop-filter backdrop-blur-lg bg-opacity-20">
                <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 z-10 relative">
                    <h1 className="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 animate-pulse md:text-5xl lg:text-6xl dark:text-white"><div class="h-5 bg-gray-500 rounded-full max-w-[640px] mb-3.5 mx-auto"></div></h1>
                    ...
                    <form className="w-full max-w-md mx-auto animate-pulse">
                        ...
                        <div className="relative hover:cursor-wait">
                            ...
                            <input type="email" id="default-email" disabled className="hover:cursor-wait block w-full p-4 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-white focus:ring-red-500 focus:border-red-500" placeholder="Enter your email here..." required />
                            <button type="submit" disabled className="hover:cursor-wait text-white absolute right-2.5 bottom-2.5 bg-red-700 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-4 py-2">Subscribe</button>
                        </div>
                    </form>
                </div>
