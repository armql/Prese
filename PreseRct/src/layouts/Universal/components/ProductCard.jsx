...
export default function ProductCard(item) {
    return (
        <div className="max-w-sm py-2 px-15 shadow-md bg-white backdrop-filter backdrop-blur-lg bg-opacity-97 rounded-md">
            <a href="#">
                <img className="p-8 rounded-t-lg" src={item.preview} alt="product image" />
            </a>
            <div className="px-5 pb-5">
                ...
                <div className="flex items-center justify-between">
                    <span className="text-3xl font-bold text-gray-900 dark:text-white">{item.retail_price}EUR</span>
