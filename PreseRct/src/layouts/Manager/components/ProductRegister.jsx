...
export default function ProductRegister() {
  ...
  if (submitting) {
    return (
      <div><title>Prese | Product Register</title>
          ...
          <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
            <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <form onSubmit={(event) => addProduct(event, currentUser ? currentUser.id : '')} className="space-y-4 md:space-y-6">
                ...
                <div>
                  <label for="preview" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Product preview</label>
                ...
                <div>
                  <label for="category_id" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Product category</label>
                  <select
                    onChange={handleInput}
                    name="category_id"
                    id="category"
                ...
                <div>
                  <label for="retail_price" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Retail Price</label>
                ...
                <div>
                  <label for="market_price" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Market Price</label>
