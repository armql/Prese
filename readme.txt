...
- **Role-Specific Pages:** Each role comes with dedicated webpages that cater to their unique actions and requirements within the platform.

### Roles and Functionality Overview

- **Guest:** Explore the platform and browse available food items.
- **Customer:** Place orders, track order status, manage personal orders.
- **Employee:** Handle order management tasks, assign orders to drivers.
