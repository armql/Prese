...
export default function ProductCard(item) {
  return (
    <div
      key={item.id}
      className="animate-pulse max-w-sm py-2 px-15 shadow-md bg-white backdrop-filter backdrop-blur-lg bg-opacity-97 rounded-md"
    >
      <div className="flex items-center justify-center w-full">
        <div className="flex items-center justify-center w-80 h-80 bg-red-100 rounded">
          <svg
            className="w-8 h-12 text-gray-500"
