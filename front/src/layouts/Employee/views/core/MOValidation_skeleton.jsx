...
const data = [
  {
    header:
      "<h1 className='mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl'>Embrace the <mark class='animate-pulse px-2 text-white bg-red-600 rounded dark:bg-red-500'>Chaos of Food</mark> at the hottest time</h1>",
    paragraph:
  ...
  {
    header:
      "<h1 className='mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl'>Unlock the Secrets of <span class='text-red-600 animate-pulse dark:text-red-500'>Food Delivery Mayhem</span> CRM.</h1>",
    paragraph:
  ...
  {
    header:
      "<h1 className='mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl'>Dive into the <mark class='animate-pulse px-2 text-white bg-red-600 rounded dark:bg-red-500'>Abyss of Delivery</mark> Insanity</h1>",
    paragraph:
      "<p className='text-lg font-normal text-gray-500 lg:text-xl'>Join us on a rollercoaster ride into the depths of food delivery insanity. As you plunge into the abyss of long shifts, wrong addresses, and quirky customer interactions, our dark humor will be your lifeline. Embrace the madness and come out with stories to tell!</p>",
  },
];
