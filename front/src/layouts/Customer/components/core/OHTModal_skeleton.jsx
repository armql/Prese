...
export default function MOLoadingModal_skeleton() {
  return (
    <div
      id="drawer-swipe"
      className=" fixed z-40 top-96 w-full overflow-y-auto max-h-screen bg-white border-t-2 border-gray-300 transition-transform bottom-0 top-90 left-0 right-0"
      tabIndex="-1"
      aria-labelledby="drawer-swipe-label"
    >
      <div className="flex justify-between px-4 py-3">
        <h5 className="text-sm font-semibold text-gray-600 cursor-pointer">
          Close
        </h5>
        <h5 className="text-sm font-semibold text-gray-600">Order Details</h5>
      ...
      <div className="px-4 py-6 grid gap-2 sm:grid-cols-1 md-grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
        <div className="grid grid-cols-2 gap-2 animate-pulse">
          <div className="grid grid-cols-1 border-y-2 gap-2 p-4 border-l-2 items-center">
            <div className="flex items-center justify-center w-full">
              <div class="flex items-center justify-center w-40 h-40 bg-gray-300 rounded">
                <svg
                  class="w-8 h-12 text-gray-200"
          ...
          <div className="grid grid-cols-1 gap-10 border-y-2 border-r-2 p-4">
            <div className="grid grid-cols-2 gap-2 items-center">
              ...
              <p className="text-sm text-gray-500">
                <div class="h-2.5 bg-gray-200 rounded-full w-10"></div>
              </p>
            </div>
            <div className="grid grid-cols-2 gap-2 items-center">
              <h5 className="text-sm font-bold text-gray-800">
        ...
        <div className="grid grid-cols-2 animate-pulse">
          <div className="grid grid-cols-1 border-y-2 gap-2 p-4 border-l-2 items-center">
            ...
            <div className="text-gray-500 bg-gray-100 border-gray-200 p-1 w-full h-40 border-2"></div>
          </div>
          <div className="grid grid-cols-1 gap-6 border-y-2 border-r-2 p-4">
