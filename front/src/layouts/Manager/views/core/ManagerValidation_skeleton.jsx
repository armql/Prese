...
const data = [
  {
    header:
      "<h1 className='mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl'>Embrace the <mark class='animate-pulse px-2 text-white bg-red-600 rounded'>Chaos of Managing Food</mark> at the hottest time</h1>",
    paragraph:
      "<p className='text-lg font-normal text-gray-500 lg:text-xl'>Welcome to our food delivery management app, where we specialize in serving a plateful of dark humor alongside your managerial responsibilities. Brace yourself for the rollercoaster ride of juggling driver schedules, resolving customer complaints, and surviving the labyrinthine streets. Embrace the chaos, because managing food delivery is where order meets disorder!</p>",
  },
  {
    header:
      "<h1 class='mb-4 text-3xl font-extrabold text-gray-900 md:text-5xl lg:text-6xl'><span class='text-transparent bg-clip-text bg-gradient-to-r to-red-400 animate-pulse from-red-800'>Survive the Gauntlet</span> of Hungry Drivers.</h1>",
    paragraph:
  ...
  {
    header:
      "<h1 class='mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl'>Enter the <span class='underline underline-offset-3 decoration-8 animate-pulse decoration-red-400'>Twilight Zone</span> of Food Delivery Management</h1>",
    paragraph:
