...
export default function CategoryRegister() {
  ...
  if (submitting) {
    return (
      <div><title>Prese | Category Register</title>
            ...
            <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <form onSubmit={(event) => addCategory(event, currentUser ? currentUser.id : '')} className="space-y-4 md:space-y-6">
                ...
                <div>
                  ...
                  <input type="category" value={category.name} onChange={handleInput} name="name" id="category" className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="Category" required="" />
                  <div className="mt-1">
