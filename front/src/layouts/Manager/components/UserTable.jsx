  ...
  userDetails = user.map((item, index) => {
        ...
        <tr key={index}>
          ...
          <td className="px-6 py-4 whitespace-nowrap">
            <div className="flex items-center justify-center active:scale-105">
              <Link
                to={`useredit/${item.id}`}
                className="flex gap-2 bg-cyan-100 text-black px-3 py-1 rounded-lg focus:outline-none focus:shadow-outline-blue"
                type="button"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
    ...
    return (
      <tr key={index}>
        ...
        <td className="px-6 py-4 whitespace-nowrap">
          <div className="text-center text-xs font-medium bg-gray-100 uppercase text-gray-700 px-2 py-1 rounded-sm">
            {item.role}
          </div>
        </td>
        <td className="px-6 py-4 whitespace-nowrap">
        ...
        <td className="px-6 py-4 whitespace-nowrap">
          <div className="flex items-center justify-center active:scale-105">
            <Link
              to={`useredit/${item.id}`}
              className="flex gap-2 bg-sky-100 text-sky-950 px-3 py-1 rounded-lg focus:outline-none focus:shadow-outline-blue"
              type="button"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
        ...
        <td className="px-6 py-4 whitespace-nowrap">
          <div className="flex items-center justify-center active:scale-105">
            <button
              onClick={(e) => deleteUser(e, item.id)}
              className="flex bg-red-300 gap-2 px-3 py-1 rounded-lg focus:outline-none focus:shadow-outline-red text-red-950"
              type="button"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
