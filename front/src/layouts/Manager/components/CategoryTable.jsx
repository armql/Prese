...
export default function CategoryTable() {
        ...
        axiosClient
            ...
            .then(response => {
                ...
                response.data.categories.forEach((item) => {
                    axiosClient.get(`users/${item.user_id}/name`)
                        .then(res => {
    ...
    const paginate = (pageNumber) => {
        ...
        axiosClient.get(`/categories?page=${pageNumber}&perPage=${categorysPerPage}`)
            .then(response => {
